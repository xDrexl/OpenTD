...
- Pull requests affecting the game or export configuration build downloadable
  workflow artifacts.
- Manual workflow runs build downloadable artifacts without publishing a
  release.
- Pushing a `v*` tag, such as `v0.1.0`, builds both platforms and publishes the
